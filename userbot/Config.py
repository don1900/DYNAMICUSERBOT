...
if ENV:
    ...
    class Config(object):
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/don1900/DYNAMICBOT"
        )
        APP_ID = os.environ.get("APP_ID", None)
        API_HASH = os.environ.get("API_HASH", None)
        DYNAMIC_STRING = os.environ.get("DYNAMIC_STRING", None)
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "DYNAMICBOT")
        ...
        # number of rows of buttons to be displayed in .DYNAMIC command
        ...
        # number of colums of buttons to be displayed in .DYNAMIC command
