...
bot2 = TelegramClient('DON2', APP_ID, API_HASH).start(bot_token=BOT_TOKEN2) 

bot3 = TelegramClient('DON3', APP_ID, API_HASH).start(bot_token=BOT_TOKEN3) 

bot4 = TelegramClient('DON4', APP_ID, API_HASH).start(bot_token=BOT_TOKEN4) 

bot5 = TelegramClient('DON5', APP_ID, API_HASH).start(bot_token=BOT_TOKEN5) 

bot6 = TelegramClient('DON6', APP_ID, API_HASH).start(bot_token=BOT_TOKEN6) 

bot7 = TelegramClient('DON7', APP_ID, API_HASH).start(bot_token=BOT_TOKEN7) 

bot8 = TelegramClient('DON8', APP_ID, API_HASH).start(bot_token=BOT_TOKEN8) 

bot9 = TelegramClient('DON9', APP_ID, API_HASH).start(bot_token=BOT_TOKEN9) 

bot10 = TelegramClient('DON10', APP_ID, API_HASH).start(bot_token=BOT_TOKEN10) 
