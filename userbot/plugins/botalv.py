...
pm_caption += f"**┣🚀 𝖑𝖊ɠêɳ̃dẞø✞︎ : {DYNAMICversion}**\n"
pm_caption += f"**┣🚀 𝚂𝚞𝚍𝚘     : `{sudou}`**\n"
pm_caption += f"**┣🚀 𝙾𝚠𝚗𝚎𝚛     : [𝖑𝖊ɠêɳ̃d](https://t.me/The_DON)**\n"
pm_caption += f"**┗[♦️𝙶𝚛𝚘𝚞𝚙♦️](https://t.me/DYNAMIC_Userbot)┛**\n"

pm_caption += "    [✨яєρο✨](https://github.com/don1900/DYNAMICBOT) 🔹 [📜License📜](https://github.com/don1900/DYNAMICBOT/blob/master/LICENSE)"
