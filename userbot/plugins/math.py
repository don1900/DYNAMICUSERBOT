...
@DYNAMICBOT.on(admin_cmd(pattern="sin ?(.*)"))
@DYNAMICBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@DYNAMICBOT.on(admin_cmd(pattern="cos ?(.*)"))
@DYNAMICBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@DYNAMICBOT.on(admin_cmd(pattern="tan ?(.*)"))
@DYNAMICBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@DYNAMICBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@DYNAMICBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@DYNAMICBOT.on(admin_cmd(pattern="sec ?(.*)"))
@DYNAMICBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@DYNAMICBOT.on(admin_cmd(pattern="cot ?(.*)"))
@DYNAMICBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@DYNAMICBOT.on(admin_cmd(pattern="square ?(.*)"))
@DYNAMICBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@DYNAMICBOT.on(admin_cmd(pattern="cube ?(.*)"))
@DYNAMICBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
