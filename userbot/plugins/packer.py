...
@DYNAMICBOT.on(admin_cmd(pattern=r"unpack", outgoing=True))
@DYNAMICBOT.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@DYNAMICBOT.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@DYNAMICBOT.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
