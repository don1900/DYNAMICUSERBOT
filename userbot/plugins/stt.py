...
async def _(event):
    ...
    DYNAMICevent = await edit_or_reply(event, "Downloading to my local, for analysis  🙇")
    if event.reply_to_msg_id:
        ...
        if (
            ...
            await DYNAMICevent.edit("Starting analysis, using IBM WatSon Speech To Text")
            headers = {
            ...
            if "results" in r:
                ...
                await DYNAMICevent.edit(string_to_show)
            else:
                await DYNAMICevent.edit(r["error"])
