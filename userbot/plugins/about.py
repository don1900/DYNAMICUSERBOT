...
# animation Idea by @The_DON (op coder)
...
pm_caption += f"**╭────────────**\n"
pm_caption += f"┣»»»『{DYNAMIC_mention}』«««\n"
pm_caption += f"┣Lêɠêɳ̃dẞø† ~ {DYNAMICversion}\n"
pm_caption += f"┣Lêɠêɳ̃d  ~ [Owner](https://t.me/The_DON)\n"
pm_caption += f"┣Support ~ [G𝖗ουρ](https://t.me/DYNAMIC_Userbot)\n"
pm_caption += f"┣Řepô    ~ [Rєρο](https://github.com/don1900/DYNAMICBOT)\n"
pm_caption += f"**╰────────────**\n"
