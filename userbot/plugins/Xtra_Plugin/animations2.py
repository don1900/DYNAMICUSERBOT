...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](don1900/DYNAMICBOT)**",
        ...
        "__INFO:DYNAMICBOT:Logged in as 557667062__",
        "__INFO:DYNAMICBOT:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
